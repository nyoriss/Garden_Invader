...
public class RockProjectile implements Projectile{
     ...
     */
    public RockProjectile(Bird owner, int positionX, int positionY) {
        this.width = 7*3;
        this.height = 5*3;
        this.speed = 3;
        ...
        this.owner = owner;
        try {
            rock = ImageIO.read(new File("asset/sprite/projectiles/enemies/Rock/longRock.png"));
        } catch (IOException e) {
    ...
    public void draw(GamePanel gp, Graphics2D g2) {
        g2.drawImage(rock,positionX, positionY, width, height, null);
    }
